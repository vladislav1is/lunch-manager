...
public class VoteTestData {
    ...
    public static Vote getNew() {
        return new Vote(user3, restaurant2, LocalDate.of(2020, Month.DECEMBER, 2));
    }

    public static Vote getUpdated() {
        return new Vote(VOTE_ID_3, user2, restaurant2, vote3.getRegistered().plus(2, ChronoUnit.DAYS));
    }
}
