...
class JsonUtilTest {
    ...
    @Test
    void readWriteValue() {
        String json = JsonUtil.writeValue(yakitoriya);
    ...
    void readWriteValues() {
        ...
        RESTAURANT_MATCHER.assertMatch(restaurants, RestaurantTestData.restaurants);
    }

    @Test
    void writeOnlyAccess() {
        String json = JsonUtil.writeValue(UserTestData.admin1);
        System.out.println(json);
        assertThat(json, not(containsString("password")));
        String jsonWithPass = UserTestData.jsonWithPassword(convertToDto(UserTestData.admin1), "newPass");
