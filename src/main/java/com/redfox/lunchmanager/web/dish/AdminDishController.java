...
public class AdminDishController extends AbstractDishController {
    ...
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void update(@Validated(View.Web.class) @RequestBody DishTo dish, @PathVariable int id, @PathVariable int restaurantId) {
        super.update(dish, id, restaurantId);
    }

    @PostMapping(consumes = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<DishTo> createWithLocation(@Validated(View.Web.class) @RequestBody DishTo dish, @PathVariable int restaurantId) {
